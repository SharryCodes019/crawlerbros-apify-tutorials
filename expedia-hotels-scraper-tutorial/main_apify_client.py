"""Run the crawlerbros/expedia-hotels-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/expedia-hotels-scraper")
