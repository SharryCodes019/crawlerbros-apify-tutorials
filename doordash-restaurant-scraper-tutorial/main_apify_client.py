"""Run the crawlerbros/doordash-restaurant-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/doordash-restaurant-scraper")
