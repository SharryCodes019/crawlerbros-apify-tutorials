"""Run the crawlerbros/weworkremotely-job-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/weworkremotely-job-scraper")
