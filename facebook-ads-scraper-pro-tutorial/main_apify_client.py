"""Run the crawlerbros/facebook-ads-scraper-pro Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/facebook-ads-scraper-pro")
