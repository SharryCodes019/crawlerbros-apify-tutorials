"""Run the crawlerbros/arbeitsagentur-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/arbeitsagentur-scraper")
