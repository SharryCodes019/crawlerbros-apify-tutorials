# Linkedin Profile Scraper Tutorial: Run This Apify Actor with Python

Scrape LinkedIn public profiles without login. Get name, headline, experience, education, followers, and recent articles.

This repository shows how to run [Linkedin Profile Scraper](https://apify.com/crawlerbros/linkedin-profile-scraper) from Python. The complete actor README below is the canonical source of truth for inputs, outputs, examples, limits, and behavior.

## Actor Overview

- **Actor:** `crawlerbros/linkedin-profile-scraper`
- **Apify Store:** [https://apify.com/crawlerbros/linkedin-profile-scraper](https://apify.com/crawlerbros/linkedin-profile-scraper)
- **SEO title:** Linkedin Profile Scraper Tutorial: Run This Apify Actor with Python
- **Description:** Scrape LinkedIn public profiles without login. Get name, headline, experience, education, followers, and recent articles.
...
- [Run this actor on Apify](https://apify.com/crawlerbros/linkedin-profile-scraper)
