"""Run the crawlerbros/boxing-stats-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/boxing-stats-scraper")
