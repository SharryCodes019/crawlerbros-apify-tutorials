"""Run the crawlerbros/kayak-flight-hotel-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/kayak-flight-hotel-scraper")
