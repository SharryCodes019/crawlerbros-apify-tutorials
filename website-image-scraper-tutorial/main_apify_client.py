"""Run the crawlerbros/website-image-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/website-image-scraper")
