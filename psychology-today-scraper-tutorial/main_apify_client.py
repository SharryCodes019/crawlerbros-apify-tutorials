"""Run the crawlerbros/psychology-today-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/psychology-today-scraper")
