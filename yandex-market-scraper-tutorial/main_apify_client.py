"""Run the crawlerbros/yandex-market-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/yandex-market-scraper")
