"""Run the crawlerbros/tripdotcom-hotels-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/tripdotcom-hotels-scraper")
