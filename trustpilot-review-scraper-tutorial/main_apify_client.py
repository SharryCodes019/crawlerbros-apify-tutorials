"""Run the crawlerbros/trustpilot-review-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/trustpilot-review-scraper")
