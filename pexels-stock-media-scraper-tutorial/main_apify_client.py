"""Run the crawlerbros/pexels-stock-media-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/pexels-stock-media-scraper")
