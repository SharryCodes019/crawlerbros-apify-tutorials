"""Run the crawlerbros/google-scholar-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/google-scholar-scraper")
