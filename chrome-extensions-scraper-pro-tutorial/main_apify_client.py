"""Run the crawlerbros/chrome-extensions-scraper-pro Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/chrome-extensions-scraper-pro")
