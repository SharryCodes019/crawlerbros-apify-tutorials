"""Run the crawlerbros/google-earth-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/google-earth-scraper")
