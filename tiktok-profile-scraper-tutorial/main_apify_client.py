"""Run the crawlerbros/tiktok-profile-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/tiktok-profile-scraper")
