# LinkedIn Profile Scraper Pro Tutorial: Run This Apify Actor with Python
...
This repository shows how to run [LinkedIn Profile Scraper Pro](https://apify.com/crawlerbros/linkedin-profile-scraper-pro) from Python. The complete actor README below is the canonical source of truth for inputs, outputs, examples, limits, and behavior.

## Actor Overview

- **Actor:** `crawlerbros/linkedin-profile-scraper-pro`
- **Apify Store:** [https://apify.com/crawlerbros/linkedin-profile-scraper-pro](https://apify.com/crawlerbros/linkedin-profile-scraper-pro)
- **SEO title:** LinkedIn Profile Scraper Pro Tutorial: Run This Apify Actor with Python
- **Description:** Extract LinkedIn profile data including name, headline, experience, education, skills, followers, and recent articles. Works with public profiles and authenticated sessions.
...
- [Run this actor on Apify](https://apify.com/crawlerbros/linkedin-profile-scraper-pro)
