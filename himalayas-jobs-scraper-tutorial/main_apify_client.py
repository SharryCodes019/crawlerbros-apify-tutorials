"""Run the crawlerbros/himalayas-jobs-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/himalayas-jobs-scraper")
