"""Run the crawlerbros/football-stats-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/football-stats-scraper")
