"""Run the crawlerbros/twitter-screenshot-generator Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/twitter-screenshot-generator")
