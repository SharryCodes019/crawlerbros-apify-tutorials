"""Run the crawlerbros/yahoo-auctions-japan-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/yahoo-auctions-japan-scraper")
