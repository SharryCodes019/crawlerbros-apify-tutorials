"""Run the crawlerbros/tiktok-ads-library-scraper-pro Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/tiktok-ads-library-scraper-pro")
