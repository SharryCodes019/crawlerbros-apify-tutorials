"""Run the crawlerbros/michelin-guide-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/michelin-guide-scraper")
