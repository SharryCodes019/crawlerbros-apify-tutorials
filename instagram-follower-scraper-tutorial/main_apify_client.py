"""Run the crawlerbros/instagram-follower-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/instagram-follower-scraper")
