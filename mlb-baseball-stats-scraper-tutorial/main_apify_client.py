"""Run the crawlerbros/mlb-baseball-stats-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/mlb-baseball-stats-scraper")
