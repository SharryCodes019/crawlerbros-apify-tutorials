"""Run the crawlerbros/pinterest-media-downloader Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/pinterest-media-downloader")
