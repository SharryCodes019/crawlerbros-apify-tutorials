"""Run the crawlerbros/linkedin-schools-alumni-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/linkedin-schools-alumni-scraper")
