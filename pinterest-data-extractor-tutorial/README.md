# Pinterest Data Extractor Tutorial: Run This Apify Actor with Python

Scrape Pinterest pins, profiles, boards, search results, and comments. Extract images, videos, metadata, and engagement stats.

This repository shows how to run [Pinterest Data Extractor](https://apify.com/crawlerbros/pinterest-data-extractor) from Python. The complete actor README below is the canonical source of truth for inputs, outputs, examples, limits, and behavior.

## Actor Overview

- **Actor:** `crawlerbros/pinterest-data-extractor`
- **Apify Store:** [https://apify.com/crawlerbros/pinterest-data-extractor](https://apify.com/crawlerbros/pinterest-data-extractor)
- **SEO title:** Pinterest Data Extractor Tutorial: Run This Apify Actor with Python
...
- [Run this actor on Apify](https://apify.com/crawlerbros/pinterest-data-extractor)
