"""Run the crawlerbros/y-combinator-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/y-combinator-scraper")
