"""Run the crawlerbros/teachers-pay-teachers-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/teachers-pay-teachers-scraper")
