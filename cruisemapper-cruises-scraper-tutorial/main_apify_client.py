"""Run the crawlerbros/cruisemapper-cruises-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/cruisemapper-cruises-scraper")
