"""Run the crawlerbros/flight-award-scraper-pro Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/flight-award-scraper-pro")
