"""Run the crawlerbros/snapchat-spotlight-video-downloader Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/snapchat-spotlight-video-downloader")
