"""Run the crawlerbros/bing-maps-business-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/bing-maps-business-scraper")
