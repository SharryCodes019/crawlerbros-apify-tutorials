"""Run the crawlerbros/facebook-events-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/facebook-events-scraper")
