"""Run the crawlerbros/sitemap-url-extractor Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/sitemap-url-extractor")
