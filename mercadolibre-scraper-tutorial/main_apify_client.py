"""Run the crawlerbros/mercadolibre-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/mercadolibre-scraper")
