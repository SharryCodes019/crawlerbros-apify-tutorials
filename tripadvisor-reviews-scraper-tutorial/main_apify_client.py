"""Run the crawlerbros/tripadvisor-reviews-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/tripadvisor-reviews-scraper")
