"""Run the crawlerbros/opentable-resy-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/opentable-resy-scraper")
