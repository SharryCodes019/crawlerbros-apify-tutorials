"""Run the crawlerbros/responsive-website-checker Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/responsive-website-checker")
