"""Run the crawlerbros/facebook-photos-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/facebook-photos-scraper")
