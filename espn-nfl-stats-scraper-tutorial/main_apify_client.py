"""Run the crawlerbros/espn-nfl-stats-scraper Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/espn-nfl-stats-scraper")
