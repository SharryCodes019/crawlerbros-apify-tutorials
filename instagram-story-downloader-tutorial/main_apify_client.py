"""Run the crawlerbros/instagram-story-downloader Apify actor with the official Apify Python client."""
...
ACTOR_ID = os.getenv("ACTOR_ID", "crawlerbros/instagram-story-downloader")
